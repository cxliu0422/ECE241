...
hex_decorder h1(LEDR[3:0],HEX0);
hex_decorder h2(LEDR[7:4],HEX1);
    ...
    begin: enable_signals
        ...
        case (current_state)
            ...
            S_CYCLE_1: begin // Do A<- A*X*X
                ld_alu_out=1'b1; ld_a=1'b1; // store result in A again
                alu_select_a = 2'b00; // Select register A
				...
				S_CYCLE_2: begin //Do B <-B*x
					ld_alu_out=1'b1; ld_b=1'b1;// sore result back into B
				...
				S_CYCLE_3: begin //Do B <- A+B((A*X*X)+BX)
				...
				S_CYCLE_4: begin // Do B+C (((A*X*X)+BX)+C)
					ld_r=1'b1;//final result
					alu_select_a=2'b01; // select register B
					alu_select_b=2'b10; // selecy register C
					alu_op =1'b0;// do add operation
				end
